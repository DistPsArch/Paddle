...
_TABLEACCESSORPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='quantize_type', full_name='paddle.TableAccessorParameter.quantize_type', index=11,
...
_PSSERVICE = _descriptor.ServiceDescriptor(
  name='PsService',
  full_name='paddle.PsService',
  file=DESCRIPTOR,
  index=0,
  serialized_options=None,
  ...
  _descriptor.MethodDescriptor(
    name='service',
    full_name='paddle.PsService.service',
    index=0,
    containing_service=None,
    input_type=_PSREQUESTMESSAGE,
    output_type=_PSRESPONSEMESSAGE,
    serialized_options=None,
  ),
])
_sym_db.RegisterServiceDescriptor(_PSSERVICE)

DESCRIPTOR.services_by_name['PsService'] = _PSSERVICE
